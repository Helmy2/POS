...
import com.wael.astimal.pos.core.util.convertToDateString
...
fun EmployeeReportRoute(
    ...
    PdfGeneratorEffect(
        ...
        baseFileName = "employee_report_${state.selectedEmployee?.name ?: "report"}",
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(Res.string.employee_daily_report)) },
                navigationIcon = {
...
fun EmployeeReportScreen(
    ...
    Column(modifier = modifier.padding(16.dp).fillMaxSize()) {
        CustomExposedDropdownMenu(
            ...
            onItemSelected = { processEvent(EmployeeReportContract.Event.SelectEmployee(it)) },
...
@Composable
private fun TransactionRow(transaction: EmployeeTransaction) {
    Card(
        modifier = Modifier.fillMaxWidth(),
        ...
        Row(
            ...
            Text(
                transaction.createdAt.convertToDateString(),
                modifier = Modifier.weight(2f),
