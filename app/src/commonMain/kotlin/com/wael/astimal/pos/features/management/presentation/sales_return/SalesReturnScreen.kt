...
fun SalesReturnScreen(
    ...
    SearchScreen(
        screenTitle = stringResource(Res.string.sales_return),
        ...
        mainContent = {
            if (state.invoiceForPdfDialog != null) {
                Dialog(
                    onDismissRequest = { onEvent(SalesReturnContract.Event.DismissInvoiceForPdfDialog) },
                ){
                    Card {
                        Column (
                            ...
                            AppButton(
                                {
                                    onEvent(SalesReturnContract.Event.DismissInvoiceForPdfDialog)
                                },
                            ...
                            AppButton(
                                {
                                    onEvent(SalesReturnContract.Event.GeneratePdf(state.invoiceForPdfDialog))
                                    onEvent(SalesReturnContract.Event.DismissInvoiceForPdfDialog)
                                },
                                modifier = Modifier.width(320.dp)
                            ) {
