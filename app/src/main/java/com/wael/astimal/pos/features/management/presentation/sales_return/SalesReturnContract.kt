...
sealed interface SalesReturnEvent {
    ...
    data class UpdateItemUnit(val tempEditorId: String, val isMaxUnitSelected: Boolean) : SalesReturnEvent
    data class UpdateItemMaxUnitQuantity(val tempEditorId: String, val quantity: String) : SalesReturnEvent
    data class UpdateItemMinUnitQuantity(val tempEditorId: String, val quantity: String) : SalesReturnEvent
