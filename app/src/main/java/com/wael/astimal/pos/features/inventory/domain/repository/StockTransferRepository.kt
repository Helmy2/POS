...
interface StockTransferRepository {
    ...
    suspend fun addStockTransfer(fromStoreId: Long, toStoreId: Long, initiatedByUserId: Long, items: List<StockTransferItemEntity>): Result<StockTransfer>
    suspend fun updateStockTransfer(transferLocalId: Long, fromStoreId: Long, toStoreId: Long, initiatedByUserId: Long, items: List<StockTransferItemEntity>): Result<Unit>
