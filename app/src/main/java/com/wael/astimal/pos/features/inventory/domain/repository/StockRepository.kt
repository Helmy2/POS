...
interface StockRepository {
    fun getStoreStocks(query: String, selectedStoreId: Long?): Flow<Result<List<StoreStock>>>

    fun getStockQuantityFlow(storeId: Long, productId: Long): Flow<Result<Double>>

    suspend fun adjustStock(storeId: Long, productId: Long, transactionQuantity: Double)
